...
@section('container')
    ...
    <div class="flex justify-center">
        <div class="w-full bg-white rounded-md md:max-w-4xl mb-9">
    ...
    <div class="flex">
        ...
        <a href="/form/start" class="text-base font-semibold hover:bg-opacity-80 transition duration-300 ease-in-out bg-primary text-white text-center py-2 mx-auto rounded-md w-full md:max-w-4xl hover:shadow-lg">Mulai</a>
    </div>
