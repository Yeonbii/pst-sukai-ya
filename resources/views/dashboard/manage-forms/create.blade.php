...
@section('container')
    ...
    <div class="py-12">
        ...
        <form action="{{ route('storeQuestion', ['part' => $part]) }}" method="post">
            @csrf
            <div class="w-full">
                ...
                <div id="body_card" class="bg-white rounded-md shadow-md mb-9 p-7">
                    ...
                    <div id="need_note_div" class="w-full mb-7">
                        ...
                        <div id="need_note" class="mt-3">
                            ...
                            {{-- Yes --}}
                            <div class="flex items-center mb-4">
                                <input type="radio" name="need_note" id="need_note_1" value="1" class="w-4 h-4 flex-shrink-0" required onchange="need_note_change(this)">
                                <label for="need_note_1" class="ms-2 text-sm font-medium">Yes</label>
                            </div>

                            {{-- No --}}
                            <div class="flex items-center mb-4">
                                <input type="radio" name="need_note" id="need_note_0" value="0" class="w-4 h-4 flex-shrink-0" required onchange="need_note_change(this)">
                    ...
                    <div id="note_div" class="w-full mb-7 hidden">
                    ...
                    <div id="input_type_div" class="w-full mb-7">
                        ...
                        <div id="input_type" class="mt-3">
                            ...
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_1" value="1" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            {{-- Hilangkan pilihan ketika Bagian Nilai Pelayanan, Rating Pelayanan, dan Feedback --}}
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_2" value="2" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            {{-- Hilangkan pilihan ketika Bagian Nilai Pelayanan, Rating Pelayanan, dan Feedback --}}
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_3" value="3" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            {{-- Hilangkan pilihan ketika Bagian Nilai Pelayanan, Rating Pelayanan, dan Feedback --}}
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_4" value="4" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            {{-- Hilangkan pilihan ketika Bagian Nilai Pelayanan, Rating Pelayanan, dan Feedback --}}
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_5" value="5" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            {{-- Hilangkan pilihan ketika Bagian Nilai Pelayanan, Rating Pelayanan, dan Feedback --}}
                            <div class="flex items-center mb-4 {{ ($part->id == 3 || $part->id == 4 || $part->id == 5) ? 'hidden' : '' }}">
                                <input type="radio" name="input_type" id="input_type_7" value="7" class="w-4 h-4 flex-shrink-0" required onchange="input_type_change(this)">
                            ...
                            <div class="flex items-center mb-4 {{ ($part->id == 5 || $part->id == 6) ? '' : 'hidden' }}">
                                <input type="radio" name="input_type" id="input_type_9" value="9" class="w-4 h-4 flex-shrink-0" required {{ ($part->id == 5) ? 'checked' : '' }} onchange="input_type_change(this)">
                ...
                <div id="input_type_area">
                    ...
                    {{-- Input Start --}}
                    <div id="input_card" class="bg-white rounded-md shadow-md mb-9 p-7 hidden">
                        ...
                        <div id="maks_char_div" class="w-full mb-7">
                            ...
                            <p class="text-sm text-slate-500 mb-2 italic opacity-50">Masukkan 0 jika tidak mempunyai batasan</p>
                    ...
                    {{-- Select Start --}}
                    <div id="select_card" class="bg-white rounded-md shadow-md mb-9 p-7 hidden">
                        ...
                        <div id="option_number_div" class="w-full mb-7">
                            ...
                            <p class="text-sm text-slate-500 mb-2 italic opacity-50">Jika terdapat pilih Other, maka Jumlah Pilihan termasuk pilihan Other</p>
                ...
                {{-- Chart Start --}}
                <div id="chart_card" class="bg-white rounded-md shadow-md mb-9 p-7 hidden">
